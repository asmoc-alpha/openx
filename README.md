...
| [Subsystem reference](docs/subsystems/README.md) | subagents, workflows, background tasks, hooks, MCP, scaffolds, offline analysis, experience distillation, recovery |
